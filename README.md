...
├── data.py                   # Data fetching and preprocessing logic (yfinance)
├── chart.py                  # Plotly visualization logic (TradingView style)
├── technical_analysis.py     # Technical indicator computation (BB, MFI, SMA)
├── ai_analysis.py            # "Analyst" LLM integration module
├── judge_llama_analysis.py   # "Judge" LLM validation module
├── chatbot.py                # Chatbot response generation logic
